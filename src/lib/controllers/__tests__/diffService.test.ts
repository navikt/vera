...
describe("Test diffService", () => {
    ...
    it("Test Diff envs", async () => {
        const testApp = {"application": "testApp", "version": "1.0.0", "environment": "qass","environmentClass": "preprod", "deployer": "Fake Fake"};
        const testApp2 = {"application": "testApp2", "version": "1.0.1", "environment": "prod","environmentClass": "prod", "deployer": "Fake Fake"};
        const testApp3 = {"application": "testApp3", "version": "1.0.1", "environment": "test","environmentClass": "test", "deployedBy": "Fake Fake"};
