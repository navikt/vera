...
test('Version comparison', assert =>  {
    ...
    assert.equal(compare("1.2.3", "1.2.3-HOTSHOT"), 0)
    assert.equal(compare("69", "69"), 0)
    assert.equal(compare("1.2.3", "1.2"), 1)
    assert.equal(compare("1.2.0.0", "1.2"), 0)
    assert.equal(compare("1.2.34", "1.2.3"), 1)
    assert.equal(compare("1.2.3-HvaSomHelstAvTekst", "1.2.3"), 0)
    assert.equal(compare("1.2.3-HvaSomHelstAvTekst-SNAPSHOT", "1.2.3"), -1)
    assert.equal(compare("69-HL2", "69"), 0)
    assert.equal(compare("1.1", "1-fml_shait"), 1)
